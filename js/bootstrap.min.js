...
!(function (t, e) {
			...
			return (
				...
				(t._getRootElement = function (t) {
					var e = _.getSelectorFromElement(t),
						n = !1
					return (
						e && (n = document.querySelector(e)), (n = n || g(t).closest("." + d)[0])
					)
				}),
	...
	g(document)
		...
		g(window).on(j.LOAD_DATA_API, function () {
			for (
				var t = [].slice.call(document.querySelectorAll(O)), e = 0, n = t.length;
				e < n;
				e++
			) {
				var i = t[e],
			...
			return (
				...
				(r._jQueryInterface = function (i) {
					return this.each(function () {
						...
						if (
							(t || ((t = new r(this, e)), g(this).data(x, t)), "number" == typeof i)
						)
							t.to(i)
	...
	g(document).on(Y.CLICK_DATA_API, lt, ut._dataApiClickHandler),
		g(window).on(Y.LOAD_DATA_API, function () {
			for (
				var t = [].slice.call(document.querySelectorAll(ct)), e = 0, n = t.length;
				e < n;
				e++
			) {
				var i = g(t[e])
	...
	var ft = "collapse",
		...
		wt = (function () {
			function a(e, t) {
				...
				for (
					var n = [].slice.call(document.querySelectorAll(It)), i = 0, o = n.length;
					i < o;
					i++
				) {
					var r = n[i],
						...
						if ((g(this._element).trigger(i), !i.isDefaultPrevented())) {
							...
							g(this._element).removeClass(Et).addClass(Ct),
								...
								this._triggerArray.length &&
									g(this._triggerArray).removeClass(Tt).attr("aria-expanded", !0),
			...
			return (
				...
				(o._jQueryInterface = function (n, i) {
					return this.each(function () {
						...
						if (
							(t || ((t = new o(this, e)), g(this).data(ie, t)), "string" == typeof n)
						) {
							if ("undefined" == typeof t[n])
								throw new TypeError('No method named "' + n + '"')
							t[n](i)
		...
		On = (function () {
			...
			return (
				...
				(t._getConfig = function (t) {
					if (
						"string" !=
						typeof (t = l({}, _n, {}, "object" == typeof t && t ? t : {})).target
					) {
				...
				(n._jQueryInterface = function (e) {
					return this.each(function () {
						...
						if (
							(t ||
								((t = new n(this, "object" == typeof e && e)), g(this).data(fn, t)),
							"string" == typeof e)
						) {
							if ("undefined" == typeof t[e])
								throw new TypeError('No method named "' + e + '"')
