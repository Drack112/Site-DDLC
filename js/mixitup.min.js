	...
	!(function () {
					...
					(l = u[f]),
						l &&
							...
							("function" == typeof o.config.callbacks.onMixClick &&
								((s = o.config.callbacks.onMixClick.call(o.lastClicked, o.state, t, o)),
								s === !1)) ||
								("toggle" === a.type
									? r
		...
		(e.Events.prototype.fire = function (t, a, i, o) {
			...
			;(l.state = new e.State()),
				...
				i.futureState &&
					((l.futureState = new e.State()), n.extend(l.futureState, i.futureState)),
		...
		n.extend(e.Mixer.prototype, {
			...
			initControls: function () {
				var t = this,
					...
					c = -1
				switch (
					(t.callActions("beforeInitControls", arguments), t.config.controls.scope)
				) {
					case "local":
						o = t.dom.container
						break
				...
				for (l = 0; (n = e.controlDefinitions[l]); l++)
					if (t.config.controls.live || n.live) {
						...
						for (
							a = o.querySelectorAll(t.config.selectors.control + n.selector), c = 0;
							(i = a[c]);
							c++
						)
			...
			buildSortString: function (t) {
				var e = this,
					n = ""
				return (
					(n += t.sortString), t.next && (n += " " + e.buildSortString(t.next)), n
				)
			},
					...
					(a.config.animation.clampHeight || a.config.animation.clampWidth) &&
						...
						e.newWidth = a.incPadding
							...
							: o.width -
							  ...
							  parseFloat(i.borderRight),
						e.viewportDeltaX =
							e.docState.viewportWidth - this.dom.document.documentElement.clientWidth,
						e.viewportDeltaY =
					...
					for (
						i = t.showPosData[u],
							...
							n.config.animation.animateResizeTargets &&
								...
								(l =
									(i.startPosData.width || i.finalPosData.width) - i.interPosData.width),
								...
								(l =
									(i.finalPosData.width || i.startPosData.width) - i.interPosData.width),
			...
			diffDatasets: function (t) {
				...
				for (
					...
					if (h[d])
						throw new Error(
							e.messages.errorDatasetDuplicateUid({
								uid: d,
							})
						)
					;(h[d] = !0),
						(l = a.cache[d]) instanceof e.Target
							? (a.config.data.dirtyCheck &&
									...
									c !== l.dom.el &&
										(l.isInDom &&
											(l.unbindEvents(), a.dom.parent.replaceChild(c, l.dom.el)),
